defmodule Tino.PurchaseOrderController do
 ...
 def create(conn, %{"purchase_orders" => purchase_orders_params}) do
    permalink = "11111113" #Guardian.Plug.current_resource(conn) 
    changeset = PurchaseOrder.changeset(%PurchaseOrder{}, purchase_orders_params)
  ...
  def update (conn, %{"id" => id, "purchase_orders" => purchase_orders_params}) do
